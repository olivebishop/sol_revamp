...
const GrainOverlay = () => {
  return (
    <>
      ...
      <div
        className="pointer-events-none fixed inset-0 z-[100] opacity-[0.35]"
        style={{
      ...
      {/* Coarse Film Grain */}
      <div
        className="pointer-events-none fixed inset-0 z-[99] opacity-[0.25]"
        style={{
      ...
      {/* Warm Orange Tint */}
      <div
        className="pointer-events-none fixed inset-0 z-[98] opacity-[0.15]"
        style={{
